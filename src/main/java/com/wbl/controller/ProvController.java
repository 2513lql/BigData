...
import static com.wbl.modal.Enum.QueryMessage.QUERY_ID;
import static com.wbl.modal.Enum.QueryMessage.RELATIONS;
...
public class ProvController {
        ...
        public @ResponseBody
        JSONObject queryPlatformRelation(@RequestParam("dataName")String dataName) throws Exception{
        ...
        public HttpEntity getDataRelation(@RequestParam("queryId")String queryId,@RequestParam("userName")String userName,
                                          HttpServletResponse response, HttpServletRequest request){
                UserInfo userInfo = userInfoService.GetUserInfoByName(userName);
                byte[] svg = DrawImageUtil.draw(provService.produceDotString(queryId,userInfo,request));
                response.setHeader("Access-Control-Allow-Origin", "*");
                response.setHeader("Access-Control-Allow-Methods", "GET,POST,PUT,DELETE,OPTIONS");
                response.setHeader("Access-Control-Allow-Headers", "Content-Type");
                InputStream in = new ByteArrayInputStream(svg);
