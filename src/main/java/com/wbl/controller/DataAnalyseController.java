...
public class DataAnalyseController {
        ...
        @RequestMapping("/DataOperateTypeAnalyse")
        @ResponseBody
        public JSONArray DataOperateTypeAnalyse(@RequestParam("dataName") String dataName){
                JSONArray result = dataAnalyseService.getDataOperateType(dataName);
                return  result;
        }
