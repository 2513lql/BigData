...
public class GraphvizUtil {
        ...
        private static final String TEMP_DIR = "F:\\projectSum\\BigDataPlatform\\BigData\\src\\main\\webapp\\WEB-INF\\provImage";
        ...
        public static void main(String[] args) {
                ...
                gv.add("platA[URL=\"http://10.103.241.73:8090/BigDataBeta/prov/produceSvgByDotString\",color=red]");
                gv.add("platA->platB");
                gv.add("platA->platB");
                gv.add("platA->platB");
                gv.add("platB->platC");
