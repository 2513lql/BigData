<%@ page import="com.lql.domain.PolicyDesription" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function confirmSubmit() {
            ...
            //资源属性
            var resources = packageResourceAttris();
            arr.push(resources);
            ...
            var dataIdStr = "${dataIds}"; //data1;data2;data3
            arr.push(dataIdStr);
        ...
        //对资源属性进行封装
        function packageResourceAttris() {
            var resources = "resource:[";
            var securitySelect = document.getElementById("security");
            var security = "security:" + String(securitySelect.value) + ";";
            var operationMsg = "operationMsg:yes"
            resources += security;
            resources += operationMsg + ";"
            resources += "]";
            return resources;
        }
        ...
        function postData(arr) {
            $.ajax({
                async: false,
                url: "<%=path%>/accontroller/registePolicy.action",
        ...
        function getAttributes() {
            ...
            $.ajax({
                async: false,
                url: "<%=path%>/accontroller/attributes.action",
                type: "GET",
        ...
        function getIpRegexs() {
            $.ajax({
                async: false,
                url: "<%=path%>/accontroller/ipregs.action",
                type: "GET",
                dataType: "json",//服务器返回数据类型
                success: function (data) {
                    parseIpRegs(data);
...
<div class="container">
    ...
    <div class="panel panel-default" id="oldPolicyPanel">
        <div class="panel-heading" style="cursor:pointer;" id="policyPanelBtn" >
            <h4 class="trigger" style="color: blue;">数据现有访问策略</h4>
        </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="security1" class="col-sm-3 control-label">安全级别</label>

                            <div class="col-sm-8">
                                <input type="text" style="height: 35px;" value="${policyDescription.security}" disabled class="form-control"
                                       id="security1" placeholder="security">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="operations1" class="col-sm-3 control-label">操作</label>

                            <div class="col-sm-8">
                                <input type="text" value="${policyDescription.operations}" style="height: 35px;" disabled class="form-control"
                                       id="operations1"
                                       placeholder="用户属性">
                            </div>
                        </div>
                                ...
                                <tr>
                                    <td>
                                        <table class="normal" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td style="padding-left: 0px !important; padding-right: 0px !important">
                                                                <select class="form-control" id="security">
                                                                    ...
                                                                    <option value="policy">属性门限</option>
                                                                    <option value="privacy">私密数据</option>
                                                                    <option value="public">公开数据</option>
                                                                </select>
                                                            </td>
                                                            <td style="padding-left: 10px !important; padding-right: 0px !important">
                                                                <%--<input type="checkbox" name="operationMsg" id="operationMsg" value="yes" checked>数据操作信息可见</input>--%>
                                                            </td>
                                            ...
                                            <tr>
                                                <td class="leftCol-small"><h5>操作</h5></td>
                                                <td>
                                                    <table class="normal"
                                                        ...
                                                        <tr>
                                                            <td style="padding-left: 10px !important; padding-right: 0px !important">
                                                                <input type="checkbox" name="read" id="read"
                                                                       value="read" checked>read</input>
                                                                <input type="checkbox" name="update" id="update"
                                                                       value="update"
                                                                       style="margin-left: 5px;">update</input>
                                                                <input type="checkbox" name="delete" id="delete"
                                                                       value="delete"
                                                                       style="margin-left: 5px;">delete</input>
                                                                <input type="checkbox" name="download" id="download"
                                                                       value="download"
                                                                       style="margin-left: 5px;">download</input>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                ...
                <tr>
                    <td class="buttonRow" colspan="2">
                        <input
                                ...
                                class="btn btn-primary btn-sm" style="width:200px;" type="button">
                        <input
                                value="返回"
                                onclick="window.history.back()"
                                class="btn btn-primary btn-sm" style="width:200px;margin-left: 30px" type="button">
                    </td>
                </tr>
                </tbody>
            </table>
...
<script>
    ...
    function selectDataId() {
        var selectIdDataId = document.getElementById("dataList").value;
        $.ajax({
            async: false,
            url: "<%=path%>/accontroller/policydescription.action",
            data: {dataId: selectIdDataId},
            type: "GET",
            dataType: "JSON",
            success: function (data) {
                $("#policyName1").val(data["policyDescription"]["policyName"]);
                $("#description1").val(data["policyDescription"]["description"]);
                $("#security1").val(data["policyDescription"]["security"]);
                $("#effect1").val(data["policyDescription"]["effect"]);
                $("#userAttris1").val(data["policyDescription"]["userAttris"]);
                $("#operations1").val(data["policyDescription"]["operations"]);
                $("#network1").val(data["policyDescription"]["network"]);
                $("#time1").val(data["policyDescription"]["time"]);
                $("#ipRegexp").val(data["policyDescription"]["ip"]);
            }
        });
    }
